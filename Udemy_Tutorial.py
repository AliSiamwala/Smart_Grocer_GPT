...
openai.api_key = "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"
...
response = openai.ChatCompletion.create(
    model="gpt-3.5-turbo",
    messages=[
        {"role":"system","content": "You are a helpful assistant that creates a diet based on the list of foods that I provide you."},
        {"role":"user","content": "Generate me a 5 line poem about the topic of choosing"},
